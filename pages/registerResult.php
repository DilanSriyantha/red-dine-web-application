                    ...
                    <?php
                        ...
                        if($status == "success"){
                            ...
                            <div class='form-header' style='flex-direction: column;'>
                                <div style='border: 1px solid #1cb615; border-radius: 100px; width: 50px; height: 50px; display: flex; justify-content: center; align-items: center;'>
                                    <h1>✔️</h1>
                                </div>
                            ...
                            echo("<div class='form-header' style='flex-direction: column;'>
                            ...
                            <div class='display-flex' style='justify-content: center; align-items: center;'>
                                <p>You will be redirected to register page in <span id='timeout'>0</span></p>
                            </div>");
                        }
                    ?>
                    <!-- <hr> -->
